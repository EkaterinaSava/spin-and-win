(function() {
  ...
  AbstractChosen = (function() {
    function AbstractChosen(form_field, options) {
      ...
      /* На мобильной версии отображаем селекты нативными только если в них нет поиска */
      if (options.disable_search === true && !AbstractChosen.browser_is_supported()) {
        return;
      }
  ...
  $.fn.extend({
    chosen: function(options) {
      /*
      На мобильной версии отображаем селекты нативными только если в них нет поиска
      Если убрать эту строчку, то будет валится ошибка при попытке destroy
      для мобильных селектов с поиском
      */
      if (options.disable_search === true && !AbstractChosen.browser_is_supported()) {
        return this;
      }
